...
void smb349_partial_reg_dump(void)
{
	...
	switch_freq = smb349_get_switch_freq();
	...
	aicl_complete = smb349_is_AICL_complete();
	 ...
	 pr_smb_info("fastchg_curr=%d,aicl_result=%d,switch_freq=%d, power_ok=%d,"
		 "  aicl_enable=%d,aicl_complete=%d,pwrsrc_disabled=%d,batt_charging_disabled=%d\n",
			fastchg_curr,
			aicl_result,
			switch_freq,
			power_ok,
