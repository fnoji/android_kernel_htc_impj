...
static struct acpu_level acpu_freq_tbl_8064_v2_slow_1p7[] = {
	{ 0, { STBY_KHZ, QSB,   0, 0, 0x00 }, L2(0),   950000 },
	{ 1, {   384000, PLL_8, 0, 2, 0x00 }, L2(1),   950000 },
	{ 0, {   432000, HFPLL, 2, 0, 0x20 }, L2(7),   975000 },
	{ 1, {   486000, HFPLL, 2, 0, 0x24 }, L2(7),   975000 },
...
static struct acpu_level *acpu_freq_tbl_8064_v2_1p7[NUM_PVS] __initdata = {
	[PVS_SLOW] = acpu_freq_tbl_8064_v2_slow_1p7,
	[PVS_NOM] = acpu_freq_tbl_8064_v2_slow_1p7,
	[PVS_FAST] = acpu_freq_tbl_8064_v2_slow_1p7,
	[PVS_FASTER] = acpu_freq_tbl_8064_v2_slow_1p7,
};

static struct acpu_level *acpu_freq_tbl_8064_v2_2p0[NUM_PVS] __initdata = {
	[PVS_SLOW] = acpu_freq_tbl_8064_v2_slow_2p0,
	[PVS_NOM] = acpu_freq_tbl_8064_v2_slow_2p0,
	[PVS_FAST] = acpu_freq_tbl_8064_v2_slow_2p0,
	[PVS_FASTER] = acpu_freq_tbl_8064_v2_slow_2p0,
};
...
static int __init get_speed_bin(void)
{
